...
nnoremap <silent>  :call CtrlPCommand()
snoremap  b<BS>
nnoremap   :noh
snoremap % b<BS>%
snoremap ' b<BS>'
...
xmap \ :NERDTreeTabsToggle
omap \ :NERDTreeTabsToggle
vmap ]% ]%m'gv``
snoremap ^ b<BS>^
snoremap ` b<BS>`
vmap a% [%v]%
...
nnoremap <silent> <C-P> :call CtrlPCommand()
...
set runtimepath+=~/.vim/bundle/matchit.zip
set runtimepath+=~/.vim/bundle/AutoTag
set runtimepath+=~/.vim/bundle/tabular
set runtimepath+=~/.vim/bundle/vim-gitgutter
set runtimepath+=~/.vim/bundle/nerdtree-git-plugin
set runtimepath+=~/.vim/bundle/vim-expand-eegion
...
set runtimepath+=~/.vim/bundle/L9/after
set runtimepath+=~/.vim/bundle/matchit.zip/after
set runtimepath+=~/.vim/bundle/AutoTag/after
...
set wildignore=*.o,*.obj,*~,*/.git/*,*/.hg/*,*/.svn/*,*/tmp/*,*.so,*.swp,*.zip,*/node_modules/*
set wildmenu
